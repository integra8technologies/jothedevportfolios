...
!(function (e, t) {
    ...
    function I(e) {
        return (
            ...
            ("string" == typeof e && !1 !== we.config().nullTargetWarn ? console.warn("Element not found:", e) : null)
        );
    }
    function J(t, e) {
        var r = e.s,
            ...
            (we = e || q()) &&
                ...
                (Pe = C.isTouch =
                    Ae.matchMedia && Ae.matchMedia("(hover: none), (pointer: coarse)").matches
                        ? 1
                        : "ontouchstart" in Ae || 0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints
                        ? 2
                        : 0),
                (ze = C.eventTypes =
                    (
                ...
                if (!Oe(e, 1)) {
                    ...
                    (se.x = t),
                        ...
                        (i || Math.abs(se.startX - t) >= a || Math.abs(se.startY - r) >= a) &&
                            (h && (re = !0), i || (se.isDragging = !0), Se(n, o), i || (p && p(se)));
                }
            }
            function Ve(t) {
                if (!Oe(t, 1)) {
            ...
            (te = se._dc =
                ...
                (se.disable = function () {
                    se.isEnabled &&
                        ...
                        se.isPressed && (se._vx.reset(), se._vy.reset(), B(F ? n : ve, ze[1], Te, !0)),
    ...
    function Ha(e, t) {
        ...
        return (r = "scroll" + n) && (i = y(e, r))
            ? i() - Ea(e)()[o]
            : Da(e)
            ? (Ue[r] || et[r]) - (je["inner" + n] || Ue["client" + n] || et["client" + n])
            : e[r] - e["offset" + n];
    }
    function Ia(e, t) {
    ...
    function Ab() {
        (h && h.isPressed && !(h.startX > et.clientWidth)) ||
            (k.cache++, (w = w || requestAnimationFrame(U)), ht || V("scrollStart"), (ht = gt()));
    }
    function Bb() {
        ...
        U = function _updateAll(e) {
            if (!ft || 2 === e) {
                ...
                if (
                    ((Dt = o < G ? -1 : 1),
                    (G = o),
                    n && (ht && !it && 200 < r - ht && ((ht = 0), V("scrollEnd")), (nt = _), (_ = r)),
                    Dt < 0)
                ) {
            ...
            ((ScrollTrigger.prototype.init = function init(S, T) {
                if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), vt)) {
                    ...
                    if (
                        ...
                        (_e.vars = S),
                        (T = T || S.animation),
                        "refreshPriority" in S && ((st = 1), -9999 === S.refreshPriority && (dt = _e)),
                        ...
                        oe &&
                            (!1 === ie || ie === kt || (ie = !(!ie && "flex" === db(oe.parentNode).display) && Tt),
                            (_e.pin = oe),
                    ...
                    (_e.previous = function () {
                                ...
                                if (oe && e && ht) nb(ScrollTrigger, "scrollEnd", Fb);
                                    ...
                                    for (
                                        var r,
                                            ...
                                            b = S.end,
                                            m = S.endTrigger || ne,
                                            y = S.start || (0 !== S.start && ne ? (oe ? "0 0" : "0 100%") : 0),
                                            x = (_e.pinnedContainer = S.pinnedContainer && I(S.pinnedContainer)),
                                    ...
                                    for (
                                        Ka(y) && (y = y(_e)),
                                            M = _b(y, ne, d, ge, Me(), C, D, _e, p, we, me, g, fe) || (oe ? -0.001 : 0),
                                            Ka(b) && (b = b(_e)),
                                            Ja(b) &&
                                                !b.indexOf("+=") &&
                                                (~b.indexOf(" ")
                                                    ? (b = (Ja(y) ? y.split(" ")[0] : "") + b)
                                                    : ((h = tb(b.substr(2), d)), (b = Ja(y) ? y : M + h), (m = ne))),
                                            O =
                                                Math.max(
                                                    M,
                                                    _b(
                                    ...
                                    if (
                                        ...
                                        for (n = ne.parentNode; n && n !== et; )
                                            n._pinOffset && ((M -= n._pinOffset), (O -= n._pinOffset)),
                                                (n = n.parentNode);
                                    f &&
                                        ...
                                        _e.revert(!1, !0),
                                        q && ((Ae = -1), _e.isActive && Me(M + z * j), q.restart(!0)),
                                        (ot = 0),
                                        T &&
                                            he &&
                                            (T._initted || G) &&
                        ...
                        (_e.update = function (e, t, r) {
                            if (!fe || r || e) {
                                ...
                                if (
                                    ...
                                    if (
                                        ((a = (s = (n = _e.isActive = !!d && d < 1) != (!!p && p < 1)) || !!d != !!p),
                                        ...
                                        he ||
                                            (!W || ot || pt
                                                ...
                                                : ((fe || (dt && dt !== _e)) && W.render(W._dp._time - W._start),
                                                  W.resetTo
                        ...
                        (_e.disable = function (e, t) {
                            if (
                                ...
                                for (var r = Pt.length; r--; ) if (Pt[r].scroller === ve && Pt[r] !== _e) return;
    ...
    function fc(e, t) {
        !0 === t
            ...
            : (e.style.touchAction = !0 === t ? "auto" : t ? "pan-" + t + (C.isTouch ? " pinch-zoom" : "") : "none"),
            e === Ue && fc(et, t);
    }
    function hc(e) {
        var t,
    ...
    function mc(e) {
        ...
        var n,
            ...
            m = 1,
            y =
                (C.isTouch && je.visualViewport ? je.visualViewport.scale * je.visualViewport.width : je.outerWidth) /
                je.innerWidth,
            x = 0,
            w = Ka(t)
                ? function () {
