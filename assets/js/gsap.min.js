...
!(function (t, e) {
    ...
    function gb(h, e) {
        ...
        return (
            !r &&
                v(h) &&
                ((l = r = h.radius || U),
                h.values ? ((h = Mt(h.values)), (f = !t(h[0])) && (l *= l)) : (h = fb(h.increment))),
            Wa(
                e,
                r
                    ? s(h)
                        ...
                        : function (e) {
                              for (
                                  ...
                                  (r = f ? (r = h[u].x - n) * r + (i = h[u].y - a) * i : Math.abs(h[u] - n)) < s &&
                                      ((s = r), (o = u));
    ...
    var qt,
        ...
        Ut =
            ...
            (qt.totalDuration = function totalDuration(t) {
                return arguments.length
                    ? ((this._dirty = 0),
                      Ra(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
                    : this._tDur;
            }),
            ...
            (qt.restart = function restart(t, e) {
                return this.play().totalTime(t ? -this._delay : 0, w(e)), this._dur || (this._zTime = -X), this;
            }),
            ...
            (qt.isActive = function isActive() {
                ...
                return !(
                    e &&
                    !(this._ts && this._initted && e.isActive() && (t = e.rawTime(!0)) >= r && t < this.endTime(!0) - X)
                );
            }),
    ...
    var Xt = (function (i) {
        ...
        return (
            ...
            (e.staggerFromTo = function staggerFromTo(t, e, r, i, n, a, s, o) {
                return (
                    (i.startAt = r), (va(i).immediateRender = w(i.immediateRender)), this.staggerTo(t, e, i, n, a, s, o)
                );
            }),
            ...
            (e.remove = function remove(t) {
                return r(t)
                    ...
                    : s(t)
                    ? this.killTweensOf(t)
                    : (t.parent === this && ya(this, t), t === this._recent && (this._recent = this._last), Aa(this));
            }),
                ...
                return arguments.length
                    ? ((this._forcing = 1),
                      !this._dp &&
                          this._ts &&
                          (this._start = ja(
                              Rt.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts)
                          )),
                    ...
                    if (Z(x))
                        ...
                        for (l in u)
                            for (
                                ...
                                ((z = { ease: (S = A[o]).e, duration: ((S.t - (o ? A[o - 1].t : 0)) / 100) * _ })[l] =
                                    S.v),
                                    s.to(C, z, E),
                                    (E += z.duration);
                        ...
                        if (
                            ...
                            e < 0 && Ca(t, e, 0, !0),
                                ...
                                (e >= t._tDur || e < 0) &&
                                    ...
                                    r ||
                                        L ||
                                        (Ct(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
            ...
            (e.kill = function kill(t, e) {
                if ((void 0 === e && (e = "all"), !(t || (e && "all" !== e))))
                    return (
                        ...
                        this.parent ? tb(this) : this.scrollTrigger && this.scrollTrigger.kill(!!L),
                        this
                    );
                if (this.timeline) {
                ...
                for (
                    ...
                    if (~d.indexOf(f[l]))
                        ...
                        o))
                            (h = a && a[u]) &&
                                (("kill" in h.d && !0 !== h.d.kill(u)) || ya(this, h, "_pt"), delete a[u]),
                                "all" !== s && (s[u] = 1);
    ...
    var Se = {
        ...
        quickTo: function quickTo(t, i, e) {
            ...
            var r,
                n = ze.to(t, qa((((r = {})[i] = "+=0.1"), (r.paused = !0), (r.stagger = 0), r), e || {}));
            return ($x.tween = n), $x;
        },
        ...
        exportRoot: function exportRoot(t, e) {
            ...
            for (
                ...
                (i = r._next),
                    (!e && !r._dur && r instanceof $t && r.vars.onComplete === r._targets[0]) ||
    ...
    function Td(t) {
        var e,
            r = t.ownerSVGElement,
            i = Od("svg", (r && r.getAttribute("xmlns")) || "http://www.w3.org/2000/svg"),
            n = t.cloneNode(!0);
    ...
    function xe(t, e, r) {
        ...
        for (n in (l.svg
            ...
            : ((a = getComputedStyle(r)[cr]), (f[cr] = e), (i = kr(r, 1)), (f[cr] = a)),
        ar))
            (a = l[n]) !== (s = i[n]) &&
    ...
    var Ee,
        ...
        yr = function _get(t, e, r, i) {
            ...
            return (
                ...
                ar[e] && "transform" !== e
                    ? ((n = kr(t, i)),
                      (n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : Or(Pd(t, pr)) + " " + n.zOrigin + "px"))
        ...
        kr = function _parseTransform(t, e) {
            ...
            return (
                ...
                r.svg &&
                    ((M = r.uncache
                        ? ((P = t.getBBox()), (B = r.xOrigin - P.x + "px " + (r.yOrigin - P.y) + "px"), "")
                ...
                (r.x =
                    i -
                    ((r.xPercent =
                        i && ((!e && r.xPercent) || (Math.round(t.offsetWidth / 2) === Math.round(-i) ? -50 : 0)))
                ...
                (r.y =
                    n -
                    ((r.yPercent =
                        n && ((!e && r.yPercent) || (Math.round(t.offsetHeight / 2) === Math.round(-n) ? -50 : 0)))
                ...
                (r.zOrigin = parseFloat(B.split(" ")[2]) || (!e && r.zOrigin) || 0) && (F[pr] = Or(B)),
                ...
                e))
                    if ("autoRound" !== d && ((o = e[d]), !pt[d] || !ac(d, e, i, n, t, a)))
                        if (
                            ...
                            if (
                                (k && d in k
                                    ? ((s = "function" == typeof k[d] ? k[d].call(i, n, t, a) : k[d]),
                                ...
                                if (
                                    ...
                                    g ||
                                        ...
                                        ((g = this._pt =
                                            new _e(this._pt, x, cr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)),
                                    "scale" === d)
                                )
                                    (this._pt = new _e(
                                        this._pt,
                            ...
                            if (m || ((u || 0 === u) && (h || 0 === h) && !fr.test(o) && d in x))
                                (u = u || 0),
                                    (c = (s + "").substr((h + "").length)) !==
                                        (p = Ya(o) || (d in q.units ? q.units[d] : c)) && (h = _d(t, d, s, p)),
                                    (this._pt = new _e(
                                        this._pt,
                                        m ? v : x,
                                        d,
